...
kernel void collision(global t_speed* cells,
  ...
  /* Reduction */
    printf("local_id[0]=%d, local_id[1]=%d, local_size[0]=%d, local_size[1]=%d, group_size[0]=%d, group_size[1]=%d\n", get_local_id(0), get_local_id(1), get_local_size(0), get_local_size(1), get_num_groups(0), get_num_groups(1));
